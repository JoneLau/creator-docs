...
- [图像与渲染](rendering/index.md)
    ...
    - [材质系统](material-system/overview.md)
        ...
        - [Effect 资源](asset/effect.md)
            - [Effect 语法](material-system/effect-syntax.md)
                ...
                - [流程控制清单](material-system/process-control-checklist.md)
                - [Shader 书写格式](material-system/shader-fragment.md)
    ...
    - [粒子系统](particle-system/overview.md)
        ...
        - [粒子操作](particle-system/editor/index.md)
...
- [2D 对象](2d-object/index.md)
    - [创建 2D 对象](2d-object/create-ui/index.md)
    ...
    - [2D 渲染对象](2d-object/2d-render/index.md)
        ...
        - [UI 合批说明](ui-system/production-strategy/ui-batch.md)
        - [UI 材质](ui-system/production-strategy/ui-material.md)
        - [精灵](ui-system/components/editor/sprite.md)
        - [文本](ui-system/components/editor/label.md)
        - [遮罩](ui-system/components/editor/mask.md)
        - [图形](ui-system/components/editor/graphics.md)
        - [富文本](ui-system/components/editor/richtext.md)
        - [UI 静态合批](ui-system/components/editor/ui-static.md)
...
- [与面板通信](editor/extension/to-panel-messages.md)
...
- [变换工具 Gizmo](editor/scene/transform-gizmo.md)
- [index](editor/scripting/index.md)
- [图形与渲染](graphics/index.md)
...
- [arc](ui-system/components/graphics/arc.md)
- [bezierCurveTo](ui-system/components/graphics/bezierCurveTo.md)
- [circle](ui-system/components/graphics/circle.md)
- [clear](ui-system/components/graphics/clear.md)
- [close](ui-system/components/graphics/close.md)
- [ellipse](ui-system/components/graphics/ellipse.md)
- [fill](ui-system/components/graphics/fill.md)
- [fillColor](ui-system/components/graphics/fillColor.md)
- [lineCap](ui-system/components/graphics/lineCap.md)
- [lineJoin](ui-system/components/graphics/lineJoin.md)
- [lineTo](ui-system/components/graphics/lineTo.md)
- [lineWidth](ui-system/components/graphics/lineWidth.md)
- [miterLimit](ui-system/components/graphics/miterLimit.md)
- [moveTo](ui-system/components/graphics/moveTo.md)
- [quadraticCurveTo](ui-system/components/graphics/quadraticCurveTo.md)
- [rect](ui-system/components/graphics/rect.md)
- [stroke](ui-system/components/graphics/stroke.md)
- [strokeColor](ui-system/components/graphics/strokeColor.md)
- [Label 组件参考](ui-system/components/label.md)
- [Mask（遮罩）组件参考](ui-system/components/mask.md)
- [2D 渲染组件介绍](ui-system/components/render-component.md)
